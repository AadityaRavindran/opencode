...
type Endpoint3_6Request = Parameters<RawClient["server.session"]["session.recursive"]>[0]
type Endpoint3_6Input = {
  readonly sessionID: Endpoint3_6Request["params"]["sessionID"]
  readonly enabled: Endpoint3_6Request["payload"]["enabled"]
  readonly strategy?: Endpoint3_6Request["payload"]["strategy"]
}
const Endpoint3_6 = (raw: RawClient["server.session"]) => (input: Endpoint3_6Input) =>
  raw["session.recursive"]({
    params: { sessionID: input["sessionID"] },
    payload: { enabled: input["enabled"], strategy: input["strategy"] },
  }).pipe(Effect.mapError(mapClientError))
